...
export async function createMasterCustomFormApi(formData:MasterCustomForm){
    try{
        ...
        const { masterId, configurationTitle, configurationConstraint } = validatedFields;
...
export async function deleteMasterCustomFormApi(formData:DeleteMasterCustomForm)
{
    const DeleteMasterCustomFormSchema = z.object({
        ...
        formId: z.string()
                ...
                .superRefine(
                    async (data, ctx) => {
                        const existMasterCustomForm = await prisma.mastersCustomConfigurations.findFirst({
                            where:{
                                id: data.formId
                            }
                        })
